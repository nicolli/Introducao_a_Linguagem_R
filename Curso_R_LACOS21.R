#Curso de Introdução à linguagem R - LACOS 21 - 29/05/2018
...
#Verificando o diretório atual de trabalho
getwd()

#Definindo o diretório atual de trabalho
setwd()
...
# Comentar código: Ctrl+shift+c comentamos o código. Posicione o cursor nessa linha e teste! ;)
# Executar código inteiro: Ctrl+shift+enter
# Cursor para o editor: ctrl+1
# Cursor para o console: ctrl+2
# Demorando a executar: ctrl+c
# Uso de tab: autocompletar!

#R funciona como uma calculadora (Operadores aritiméticos)
3+4 #Adição
7*2 #Multiplicação
5-9 #Subtração
8/2 #Divisão
...
#Alterando o passo (usando a função seq)
#Podemos alterar a variação dos elementos. Por padrão, o passo é 1, ou seja, temos
#uma variação "1,2,3...". Se o passo é 2, teremos "1,3,5...".
...
#arquivo que está no repositório. Para importá-lo, ele precisa fazer o download dele e estar no diretório 
#onde ele está.Lembre-se que o nome do arquivo deve conter sua extensão; no nosso caso, 
...
if(n%%2==0){print("É par!")}else{print("É ímpar!")}
#Selecione tudo de if até o última chave e dê um ctrl+r
...
#Selecione tudo de for até o última chave e dê um ctrl+r
